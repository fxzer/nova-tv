...
import type { AdminConfig, AdminConfigResult } from '@/lib/admin.types'
import {
  closestCenter,
  DndContext,
  PointerSensor,
...
function UserConfig({ config, role, refreshConfig }: UserConfigProps) {
...
// 新增站点配置组件
function SiteConfigComponent({ config }: { config: AdminConfig | null }) {
