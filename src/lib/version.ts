...
const CURRENT_VERSION = '20251015124211'
...
const VERSION_CHECK_URLS = [
  'https://ghfast.top/raw.githubusercontent.com/fxzer/nova-tv/main/VERSION.txt',
  'https://raw.githubusercontent.com/fxzer/nova-tv/main/VERSION.txt',
]
...
function compareVersions(remoteVersion: string): UpdateStatus {
  try {
    // 将版本号转换为数字进行比较
    const current = Number.parseInt(CURRENT_VERSION, 10)
    const remote = Number.parseInt(remoteVersion, 10)
